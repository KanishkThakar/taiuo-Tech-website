...
function Dial() {
  return (
    <svg viewBox="0 0 80 80" aria-hidden="true">
      ...
      <path d="M16 44a24 24 0 0 1 37-20" fill="none" stroke="#1A1A1A" strokeWidth="3" strokeLinecap="round" />
      <text x="40" y="50" textAnchor="middle" fontSize="16" fontWeight="600" fill="#1A1A1A">86</text>
    </svg>
  );
}
...
function HarmonyWeb() {
  return (
    <svg viewBox="0 0 80 80" aria-hidden="true">
      <polygon points="40,16 62,32 54,58 26,58 18,32" fill="rgba(168,181,181,.25)" stroke="#9DADAD" strokeWidth="2.5" strokeLinejoin="round" />
      <polygon points="40,26 54,36 49,52 31,52 26,36" fill="none" stroke="#1A1A1A" strokeWidth="2.5" strokeLinejoin="round" />
    </svg>
  );
}
