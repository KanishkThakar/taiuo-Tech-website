...
export const btnPrimary =
  "btn btn-dark w-full disabled:pointer-events-none disabled:opacity-50";
    ...
    return (
      <div className="text-center">
        ...
        <p className="mt-3 text-[15px] text-body">
          Add <code className="rounded bg-cream px-1.5 py-0.5 text-[13px]">NEXT_PUBLIC_SUPABASE_URL</code>{" "}
          and <code className="rounded bg-cream px-1.5 py-0.5 text-[13px]">NEXT_PUBLIC_SUPABASE_ANON_KEY</code>{" "}
          to <code className="rounded bg-cream px-1.5 py-0.5 text-[13px]">.env.local</code> (see{" "}
          <code className="rounded bg-cream px-1.5 py-0.5 text-[13px]">.env.example</code>), then restart
          the server.
        </p>
