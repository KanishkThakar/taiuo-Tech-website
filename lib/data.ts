  ...
  Finances: [
    {
      num: "10-15%",
      title: "Higher salary",
      desc: "Attractive people earn 10-15% more",
      cite: "Hamermesh & Biddle, 1994, American Economic Review",
    },
    {
      num: "55%",
      title: "More sales",
      desc: "Customers 55% more likely to buy from attractive salespeople",
      cite: "Reingen & Kernan, 1993",
    },
    {
      num: "$1,261",
      title: "Bigger tips",
      desc: "Attractive servers receive $1,261 more annually",
      cite: "Parrett, 2015",
    },
    {
      num: "+32%",
      title: "Easier interviews",
      desc: "Attractive applicants perceived as more qualified",
      cite: "Puleo, 2006",
    },
  ],
  Dating: [
    {
      num: "3x",
      title: "More matches",
      desc: "Attractive profiles receive 3x more matches",
      cite: "Tyson et al., 2016",
    },
    {
      num: "68%",
      title: "First dates",
      desc: "68% more likely to get first date requests",
      cite: "Eastwick & Finkel, 2008",
    },
    {
      num: "+40%",
      title: "Relationship satisfaction",
      desc: "Couples with compatible features 40% more satisfied",
      cite: "Finkel, 2017",
    },
    {
      num: "5min",
      title: "Faster attraction",
      desc: "Attraction formed within 5 minutes of meeting",
      cite: "Willis & Todorov, 2006",
    },
  ],
  Socializing: [
    {
      num: "+47%",
      title: "More friends",
      desc: "Attractive people have 47% larger social networks",
      cite: "Reis et al., 1982",
    },
    {
      num: "2.3x",
      title: "Social invitations",
      desc: "2.3x more likely to be invited to social events",
      cite: "Langlois et al., 2000",
    },
    {
      num: "+25%",
      title: "Perceived kindness",
      desc: "Attractive people rated 25% kinder by strangers",
      cite: "Dion et al., 1972",
    },
    {
      num: "+60%",
      title: "Help offered",
      desc: "60% more likely to receive help from strangers",
      cite: "Benson et al., 1976",
    },
  ],
  Health: [
    {
      ...
      desc: "Attractive people have 12% lower stress hormones",
      cite: "Henderson & Anglin, 2003",
    },
    {
      num: "+18%",
      title: "Better sleep",
      desc: "Confidence from appearance improves sleep quality 18%",
      cite: "NHS Sleep Study, 2019",
    },
    {
      num: "-8yr",
      title: "Younger appearance",
      desc: "Consistent care can make you look 8 years younger",
      cite: "Langlois, 2006",
    },
    {
      num: "+22%",
      title: "Exercise adherence",
      desc: "22% more likely to maintain fitness routines",
      cite: "Segar et al., 2012",
    },
  ],
  Education: [
    {
      num: "+0.4",
      title: "Higher GPA",
      desc: "Attractive students score 0.4 points higher on average",
      cite: "Gordon et al., 2013",
    },
    {
      num: "+15%",
      title: "Teacher attention",
      desc: "Receive 15% more positive attention from educators",
      cite: "Clifford & Walster, 1973",
    },
    {
      num: "+28%",
      title: "Participation",
      desc: "28% more likely to participate in class discussions",
      cite: "Ritts et al., 1992",
    },
    {
      num: "+19%",
      title: "Graduation rate",
      desc: "19% higher college graduation rates",
      cite: "French et al., 2009",
    },
  ],
  Law: [
    {
      ...
      desc: "Attractive defendants receive 12% lighter sentences",
      cite: "Stewart, 1980",
    },
    {
      num: "+35%",
      title: "Jury sympathy",
      desc: "35% more likely to receive jury sympathy",
      cite: "Efran, 1974",
    },
    {
      num: "+22%",
      title: "Credibility",
      desc: "22% more credible as witnesses",
      cite: "DeSantis & Kayson, 1997",
    },
    {
      num: "+17%",
      title: "Settlement favors",
      desc: "17% more likely to receive favorable settlements",
      cite: "Zebrowitz & McDonald, 1991",
    },
  ],
  Influence: [
    {
      num: "+34%",
      title: "Persuasion",
      desc: "34% more persuasive in arguments",
      cite: "Chaiken, 1979",
    },
    {
      num: "+41%",
      title: "Leadership votes",
      desc: "41% more likely to be voted as leader",
      cite: "Spisak et al., 2012",
    },
    {
      num: "+27%",
      title: "Social media",
      desc: "27% more followers on average",
      cite: "Instagram Engagement Study, 2021",
    },
    {
      num: "+38%",
      title: "Trust",
      desc: "38% more likely to be trusted initially",
      cite: "Wilson & Eckel, 2006",
    },
  ],
  Happiness: [
    {
      ...
      desc: "23% higher overall life satisfaction scores",
      cite: "Diener et al., 1995",
    },
    {
      num: "-31%",
      title: "Depression risk",
      desc: "31% lower risk of depression",
      cite: "Umberson & Karas, 2010",
    },
    {
      num: "+19%",
      title: "Self-esteem",
      desc: "19% higher self-esteem scores",
      cite: "Major et al., 1984",
    },
    {
      num: "+26%",
      title: "Daily mood",
      desc: "26% more positive daily mood ratings",
      cite: "Karraker et al., 2012",
    },
  ],
};
...
export type FeatureIconKey = "scan" | "eye" | "flask" | "file" | "trend" | "refresh";
export type FactorIconKey = "globe" | "sliders" | "activity" | "hourglass" | "landmark";
...
export const FEATURES: Feature[] = [
  {
    ...
    desc: "We landmark 512 points of your face for precise assessments.",
  },
  {
    icon: "eye",
    title: "Realistic Visualizations",
    desc: "See a preview of what your face would look like with changes.",
  },
  {
    icon: "flask",
    title: "Evidence-Based Recommendations",
    desc: "450+ evidence-based methods to improve attractiveness.",
  },
  {
    icon: "file",
    title: "Comprehensive Report",
    desc: "Detailed breakdown of every facial feature and its harmony.",
  },
  {
    icon: "trend",
    title: "Progress Tracking",
    desc: "Track improvements over time with updated analyses.",
  },
  {
    icon: "refresh",
    title: "Continuous Improvement",
    desc: "Ongoing protocol adjustments based on your progress.",
  },
];
...
export const FACTORS: Factor[] = [
  {
    ...
    desc: "Considers unique facial traits common to your demographic.",
  },
  {
    icon: "sliders",
    title: "Personal preferences",
    desc: "Takes into account your individual style and preferences.",
  },
  {
    icon: "activity",
  ...
  {
    icon: "hourglass",
    title: "Natural aging patterns",
    desc: "Considers how skin, bone, and fat change over time.",
  },
  {
    icon: "landmark",
...
export const LEARN_ITEMS: LearnItem[] = [
  {
    thumb: "dial",
    title: "Your Taiuo biometrics",
    desc: "Your current Taiuo scores and potential for improvement.",
  },
  {
    thumb: "map",
    title: "How each feature impacts your appearance",
    desc: "Detailed breakdowns on each facial feature.",
  },
  { thumb: "web", title: "The harmony of your face", desc: "How your features work together." },
  {
    thumb: "bars",
    title: "Your features with the most potential",
    desc: "What you can improve without surgery.",
  },
  {
    thumb: "molecule",
    title: "The science underlying your protocol",
    desc: "Scientific explanations for our recommendations.",
  },
];
